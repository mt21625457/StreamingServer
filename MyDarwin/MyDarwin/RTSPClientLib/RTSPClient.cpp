...
int main(int argc, char * argv[]) 
{
    ...
    UInt32 ipAddr = (UInt32)ntohl(::inet_addr("192.168.1.245"));
    UInt16 port = 554;
    StrPtrLen theURL("rtsp://192.168.1.245/test.sdp");

	MyDarwin::RTSPClient theClient(new TCPClientSocket(Socket::kNonBlockingSocketType));
